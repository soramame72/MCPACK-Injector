                                         ...
                                         WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        HWND hSt1 = CreateWindowExW(0, L"STATIC",
            L"MCPACK Injector ver0.0.1x139\n\n"
            L"\u88FD\u4F5C\u8005: soramame72\n\n"
            L"\u00A92026 soramame72\n\n"
            L"------------------------------------\n"
            ...
            20, 15, 360, 145, hWnd, NULL, MainWindow::g_hInst, NULL);
        SendMessage(hSt1, WM_SETFONT, (WPARAM)hFont, TRUE);

        // SysLink control for URLs
        HWND hLink = CreateWindowExW(0, L"SysLink",
            L"soramame72 website:\n<a href=\"http://mamechosu.cloudfree.jp\">http://mamechosu.cloudfree.jp</a>\n\n"
            L"7-Zip website:\n<a href=\"https://www.7-zip.org/\">https://www.7-zip.org/</a>",
            WS_CHILD | WS_VISIBLE | WS_TABSTOP,
            20, 160, 360, 60, hWnd, reinterpret_cast<HMENU>(IDC_SYSLINK_URL), MainWindow::g_hInst, NULL);
        SendMessage(hLink, WM_SETFONT, (WPARAM)hFont, TRUE);

        HWND hOK = CreateWindowExW(0, L"BUTTON", L"OK",
            WS_CHILD | WS_VISIBLE | WS_TABSTOP | BS_DEFPUSHBUTTON,
            160, 230, 80, 26, hWnd, reinterpret_cast<HMENU>(IDC_ABOUT_OK), MainWindow::g_hInst, NULL);
        SendMessage(hOK, WM_SETFONT, (WPARAM)hFont, TRUE);
                                          ...
                                          WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        HWND hBtnSkip = CreateWindowExW(0, L"BUTTON", L"\u30B9\u30AD\u30C3\u30D7\u3059\u308B",
            WS_CHILD | WS_VISIBLE | WS_TABSTOP | BS_PUSHBUTTON,
            240, 130, 130, 26, hWnd, reinterpret_cast<HMENU>(103), MainWindow::g_hInst, NULL);
