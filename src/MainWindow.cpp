                                         ...
                                         WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        HWND hSt1 = CreateWindowExW(0, L"STATIC",
            L"MCPACK Injector ver0.0.1x141\n\n"
            L"\u88FD\u4F5C\u8005: soramame72\n\n"
            L"\u00A92026 soramame72\n\n"
            L"------------------------------------\n"
            ...
            20, 15, 360, 155, hWnd, NULL, MainWindow::g_hInst, NULL);
        SendMessage(hSt1, WM_SETFONT, (WPARAM)hFont, TRUE);
        ...
        HWND hLink = CreateWindowExW(0, L"SysLink",
            ...
            20, 175, 360, 70, hWnd, reinterpret_cast<HMENU>(IDC_SYSLINK_URL), MainWindow::g_hInst, NULL);
