...
// -------------------------------------------------------
{
    ...
    std::wstring defTpl  = base + L"\\world_templates";
    ...
    GetPrivateProfileStringW(
        L"Paths", L"WorldTemplates",
        defTpl.c_str(), buf, MAX_PATH, cfg.c_str());
    Settings::worldTemplatesPath = buf;
}
...
// -------------------------------------------------------
{
    ...
    WritePrivateProfileStringW(
        L"Paths", L"WorldTemplates",
        Settings::worldTemplatesPath.c_str(), cfg.c_str());
}
